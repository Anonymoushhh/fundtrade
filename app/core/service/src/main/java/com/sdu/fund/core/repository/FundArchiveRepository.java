 ...
 **/
public class FundArchiveRepository implements Repository<FundArchive> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FundArchiveRepository.class);
    ...
    public FundArchive get(String fundCode) {
        return FundArchiveConverter.FundArchiveDoconvert2FundArchive(fundArchiveMapper.selectByPrimaryKey(fundCode));
    }
