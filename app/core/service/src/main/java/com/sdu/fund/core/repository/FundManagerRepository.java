 ...
 **/
public class FundManagerRepository implements Repository<FundManager> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FundManagerRepository.class);
