...
public class IntervalUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(a.isInTheInterval("50", "50)"));
        System.out.println(a.isInTheInterval("49", "50)"));
        System.out.println(a.isInTheInterval("200", "[50,200)"));
        System.out.println(a.isInTheInterval("500", "[200,500)"));
        System.out.println(a.isInTheInterval("500", "[500"));
        System.out.println(a.isInTheInterval("50", "50]"));
        System.out.println(a.isInTheInterval("200", "(50,200]"));
        System.out.println(a.isInTheInterval("500", "(200,500]"));
        System.out.println(a.isInTheInterval("500", "(500"));
